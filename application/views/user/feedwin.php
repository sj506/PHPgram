...
<div class="d-flex flex-column align-items-center">
    ...
    ->mainimg ?>' onerror='this.error=null;this.src="/static/img/profile/defaultProfileImg_100.png"'>
                ...
                <div class="flex-grow-1 d-flex flex-column justify-content-evenly">
                    ...
                    <div class="d-flex flex-row">
<div class="flex-grow1 me-3">게시물 <span class="bold"><?= $this->data
    ->feedcnt ?></span></div>
                    <div class="flex-grow1 me-3">팔로워 <span class="bold follower"><?= $this
                        ->data->followerCnt ?></span></div>
                    <div class="flex-grow1">팔로우 <span class="bold"><?= $this
                        ->data->followCnt ?></span></div>
                    </div>

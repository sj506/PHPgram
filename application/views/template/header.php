<header class="container py-3">
    <div id="globalConst">
        <div class="d-flex flex-column flex-md-row align-items-center">
            ...
            <div class="d-inline-flex flex-grow-1 flex-shrink-0">
                <nav class="d-inline-flex flex-grow-1 flex-column flex-md-row justify-content-end">
                    <div class="d-flex flex-grow-1 flex-column flex-md-row justify-content-end">
